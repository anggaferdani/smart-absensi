    ...
    <div class="collapse navbar-collapse" id="sidebar-menu">
      <ul class="navbar-nav pt-lg-3">
        ...
        @if(auth()->user()->role == 1)
          ...
          <li class="nav-item {{ Route::is('admin.izin') ? 'active' : '' }}"><a class="nav-link {{ Route::is('admin.izin') ? 'fw-bold' : '' }}" href="{{ route('admin.izin') }}" ><span class="nav-link-icon d-md-none d-lg-inline-block"><i class="fa-solid fa-scroll"></i></span><span class="nav-link-title">Izin</span><span class="ms-auto text-warning">Pending {{ $izinPendingCount }}</span></a></li>
          <li class="nav-item {{ Route::is('admin.sakit') ? 'active' : '' }}"><a class="nav-link {{ Route::is('admin.sakit') ? 'fw-bold' : '' }}" href="{{ route('admin.sakit') }}" ><span class="nav-link-icon d-md-none d-lg-inline-block"><i class="fa-solid fa-stethoscope"></i></span><span class="nav-link-title">Sakit</span><span class="ms-auto text-warning">Pending {{ $sakitPendingCount }}</span></a></li>
        @endif
