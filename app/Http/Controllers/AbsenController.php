...
class AbsenController extends Controller
{
    ...
    public function export(Request $request)
    {
        ...
        $fileName = 'absen-' . now()->format('YmdHis') . '.' . ($type == 'excel' ? 'xlsx' : 'pdf');
        ...
        ExportAbsenJob::dispatch($request->all(), $history);
    ...
    {
        $histories = ExportHistory::where('file_name', 'like', 'absen-%')->latest()->get();
